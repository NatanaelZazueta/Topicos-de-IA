"""
╔══════════════════════════════════════════════════════════════════════════════╗
║     PROBLEMA DEL AGENTE VIAJERO (TSP) — ALGORITMOS GENÉTICOS               ║
║     20 Ciudades de España — Búsqueda de Ruta Óptima                         ║
║                                                                              ║
║     Materia   : Inteligencia Artificial                                      ║
║     Algoritmo : Algoritmo Genético (Holland, 1975)                           ║
║                                                                              ║
║     Dependencias:                                                            ║
║         pip install numpy matplotlib seaborn                                 ║
║                                                                              ║
║     Ejecución:                                                               ║
║         python AG_TSP_Espana.py                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
